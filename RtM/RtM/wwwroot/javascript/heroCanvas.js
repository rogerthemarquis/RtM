...
window.applyHeroBackground = function () {
    const hero = document.getElementById('hero-section');
    if (hero) {
        // Example: Set a gradient background
        hero.style.background = 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)';
        // Or, for a canvas or Vanta effect, initialize it here
        // e.g., VANTA.TOPOLOGY({ el: "#hero-section", ... });
    }
};
